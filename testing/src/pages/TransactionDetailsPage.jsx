  ...
  useEffect(() => {
    const getTransaction = async () => {
      try {
        ...
        // CORRECTED: Use the transaction object directly
        setTransaction(transactionData);

        // Also correct the status setter and add a check
        if (transactionData) {
        ...
        showMessage(
          error.response?.data?.message || "Error getting transaction details."
        );
      }
    };
